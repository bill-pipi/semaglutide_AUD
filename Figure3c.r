...
workdir <- "."
datafile <- file.path(workdir,"Figure3c.csv")
...
pdf(file.path(workdir,"Figure3c.pdf"),  onefile=FALSE, width=10, height=5)
...
forestplot(labeltext=tabletext, 
           ...
           title ="Incident and recurrent AUD diagnosis in patients with T2DM 
           at longer follow-up time period
