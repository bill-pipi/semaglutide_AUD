...
pdf(file.path(workdir,"Figure3a.pdf"),  onefile=FALSE, width=10, height=5.8)
...
forestplot(labeltext=tabletext, 
           ...
           title ="Incident AUD diagnosis in patients with T2DM and no prior history of AUD 
           during 12-month follow-up time period
